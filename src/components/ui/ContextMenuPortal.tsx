  ...
  const items: ContextMenuItem[] = [
    {
      ...
      label: "Reply",
      icon: Reply,
      shortcut: shortcutFor("action.reply"),
      disabled: isMulti,
      action: handleReply,
    },
    {
      ...
      label: "Reply All",
      icon: ReplyAll,
      shortcut: shortcutFor("action.replyAll"),
      disabled: isMulti,
    ...
    },
    {
      ...
      label: "Forward",
      icon: Forward,
      shortcut: shortcutFor("action.forward"),
      disabled: isMulti,
    ...
    { id: "sep-1", label: "", separator: true },
    {
      ...
      label: "Archive",
      icon: Archive,
      shortcut: shortcutFor("action.archive"),
    ...
    },
    {
      ...
      icon: Trash2,
      shortcut: shortcutFor("action.delete"),
      danger: isTrashView,
      action: handleDelete,
    },
    {
    ...
    },
    {
      ...
      icon: Star,
      shortcut: shortcutFor("action.star"),
    ...
    { id: "sep-2", label: "", separator: true },
    {
      ...
      label: "Snooze...",
      icon: Clock,
      shortcut: shortcutFor("action.snooze"),
      action: handleSnooze,
    },
    {
      id: "toggle-pin",
      ...
      icon: Pin,
      shortcut: shortcutFor("action.pin"),
    ...
    },
    {
      ...
      icon: VolumeX,
      shortcut: shortcutFor("action.mute"),
    ...
    },
    {
      ...
      icon: Ban,
      shortcut: shortcutFor("action.spam"),
      action: handleSpam,
    },
      ...
      : []),
    {
      ...
      icon: FolderInput,
      shortcut: shortcutFor("action.moveToFolder"),
      action: () => {
