/**
 * Lightweight SVG Icon helper for Velo UI.
 * Standard Lucide icon definitions formatted for fast SVG rendering.
 */
...
const ICONS: Record<string, string> = {
  ...
  spam: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"></path><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line>',
  snooze: '<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline>',
  ...
  tasks: '<path d="m9 11 3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>',
...
export function renderIcon(name: string, className = "w-4 h-4"): string {
  const content = ICONS[name] ?? ICONS["file"];
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="${className}">${content}</svg>`;
}
